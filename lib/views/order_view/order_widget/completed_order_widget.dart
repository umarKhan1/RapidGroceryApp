...
Widget completedOrderWidget({BuildContext? context}) {
 ...
 child:  ListView.builder(
  shrinkWrap: true,
  itemCount: CompletedOrder.completedModelList.length,
   ...
   return  Card(
        ...
        child: Container(
            ...
            child:
              ...
              orderID(context,  CompletedOrder.completedModelList[index].orderId!),
              const SizedBox(
                height: 5,
              ),
              Divider(
              ...
              totalBill(context, "\$${ CompletedOrder.completedModelList[index].totalcost!}"),
              const SizedBox(
                height: 5,
              ),
              Divider(
              ...
              status(context,  CompletedOrder.completedModelList[index].status!),
              const SizedBox(
                height: 5,
              ),
...
Widget status(BuildContext context, String orderID,) {
    var height = MediaQuery.of(context).size.height / 100;
